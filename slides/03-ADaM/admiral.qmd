...
## Reading in our spec for ADSL (ADSL Lines: 20-25 )
...
## Combine Parent and Supplementary Data (ADSL Line 53 )
...
## Let's turn a `--DTC` to a `*DTM` variable (ADSL Lines: 57-69, 132-136, 198-204)
...
## Let's get a merge  (ADSL Lines: 72-84, and more!!)
...
## Let's derive a Duration Variable (ADSL Lines: 122-126)
...
## Let's apply Control Terms / Code Lists (ADSL Lines: 276-282)
