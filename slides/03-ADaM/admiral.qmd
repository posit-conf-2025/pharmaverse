...
and the `ADSL` created in the script.  
* Both datasets are also housed in the [pharmaverseadam package]

## ADVS - Subject Level Dataset

<div style="text-align: center;"> <img src="./images/advs.png" alt="advs" style="width: 600px;"/> </div>

* ADVS - Basic Data Structure (BDS) Dataset. Focus on adding records, but also some variables!
* We will use SDTM data `vs` from the [pharmaversesdtm package]
