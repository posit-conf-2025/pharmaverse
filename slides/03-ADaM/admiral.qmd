...
-   I will walk you through certain parts of the  `ADSL` and `ADVS` R scripts
    - Let's take a quick peek at [scripts](TBL).
    -   Discussion on **certain** functions and function arguments from [scripts](TBL) for deriving variables/records. 
...
- What is in the the Specs:
  ...
  -   Codelists!!
  -   No VLMs 
- Let's take a quick peek at [metadata](TBL)
