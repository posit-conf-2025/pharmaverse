...
adsl |> 
  ...
  tbl_roche_summary(by = ARM2, include = c(AGE, ETHNIC))
```

## What else is in {crane}? <img src="https://raw.githubusercontent.com/insightsengineering/crane/main/man/figures/logo.png" align="right" height="120"/>

::: small
At Roche, we report AEs differently than what you find in the FDA specs: we export `tbl_hierarchical_rate_and_count()`.
:::

::: smaller
-   A combo of {gtsummary} functions `tbl_hierarchical()` and `tbl_hierarchical_count()`.
:::
